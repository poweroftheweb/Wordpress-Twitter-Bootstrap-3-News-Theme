...
<div id="comments" class="comments-area">
  ...
  <header>
    <h2 class="comments-title">
      <?php
					printf( _nx( 'One thought on &ldquo;%2$s&rdquo;', '%1$s thoughts on &ldquo;%2$s&rdquo;', get_comments_number(), 'comments title', '_potw' ),
  ...
  <ol class="comment-list media-list">
    <?php
				 ...
				 * See comment() in includes/template-tags.php for more.
				 */
				wp_list_comments( array( 'callback' => 'comment', 'avatar_size' => 50 ) );
			?>
  </ol>
  <!-- .comment-list -->
  <?php if ( get_comment_pages_count() > 1 && get_option( 'page_comments' ) ) : // are there comments to navigate through ?>
